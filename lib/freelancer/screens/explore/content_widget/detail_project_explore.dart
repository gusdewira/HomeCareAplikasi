...
class DetailProjectExplore extends ConsumerWidget {
  final ProjectFreelancerModel? projectExplore;
  const DetailProjectExplore({super.key, this.projectExplore});
              ...
              Positioned(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Textr(
                      '${projectExplore!.startSalary} - ${projectExplore!.endSalary}',
                      style: Gfont.color(LzColors.hex('595959')).fsize(13),
                      margin: Ei.only(t: 5),
                      width: 350,
                    ),
